...
return {
    ...
    TelescopeBorder = { fg = c.grey3, bg = c.none },
    TelescopeSelection = { fg = c.white, bg = c.grey5 },
    TelescopeResultsTitle = { fg = c.grey3, bg = c.none },
    TelescopePromptBorder = { fg = c.brown4, bg = c.none },
    TelescopePromptTitle = { fg = c.red5, bg = c.none },
