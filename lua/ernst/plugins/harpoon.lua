return { {
    ...
    config = function(spec)
        ...
        require("which-key").add(
            {
                {
                    { "<leader>ah",       mark.add_file,                  desc = "Harpoon: add file",   nowait = true, remap = false },
                    { "<leader><spance>", ui.toggle_quick_menu,           desc = "Harpoon: quick menu", nowait = true, remap = false },
