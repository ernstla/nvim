...
-- NerdCommenter
map('n', '<C-_>', ':call nerdcommenter#Comment("n", "Invert")<CR>', opts) -- <C-_> means <C-/> -- see :help :map-special-keys
map('v', '<C-_>', ':call nerdcommenter#Comment("v", "Invert")<CR>', opts) -- <C-_> means <C-/> -- see :help :map-special-keys
-- Rest Client
