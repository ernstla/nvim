...
hl(0, 'nimPragma', { fg = '#b4637a' })
hl(0, 'nimKeywordOperator', { fg = '#97b060' })
hl(0, 'nimComment', { fg = '#505345' })
hl(0, 'nimQuote', { fg = '#ffc48c' })
hl(0, 'nimString', { fg = '#ffc48c' })
hl(0, 'nimRawString', { fg = '#ffc48c' })
hl(0, 'nimPreCondit', { fg = '#fd981f' })
hl(0, 'nimPreProcStmt', { fg = '#fd981f' })
hl(0, 'nimConstant', { fg = '#cb4b16' })
hl(0, 'nimNumber', { fg = '#cb4b16' })
hl(0, 'nimSugUnknown', { fg = '#f2e9e1' }) -- Error
hl(0, 'nimSugParam', { fg = '#f2e9e1' }) -- Identifier
hl(0, 'nimSugModule', { fg = '#f2e9e1' }) -- Identifier
hl(0, 'nimSugType', { fg = '#fdca49' }) -- Type
hl(0, 'nimSugGenericParam', { fg = '#f2e9e1' }) -- Type
hl(0, 'nimSugVar', { fg = '#f2e9e1' }) -- Identifier
hl(0, 'nimSugGlobalVar', { fg = '#f2e9e1' }) -- Identifier
hl(0, 'nimSugLet', { fg = '#f2e9e1' }) -- Identifier
hl(0, 'nimSugGlobalLet', { fg = '#f2e9e1' }) -- Identifier
hl(0, 'nimSugConst', { fg = '#f2e9e1' }) -- Constant
hl(0, 'nimSugResult', { fg = '#f2e9e1' }) -- Special
hl(0, 'nimSugProc', { fg = '#d7dfc0' }) -- Function
hl(0, 'nimSugFunc', { fg = '#ffc48c' }) -- Function
hl(0, 'nimSugMethod', { fg = '#f2e9e1' }) -- Function
hl(0, 'nimSugIterator', { fg = '#f2e9e1' }) -- Function
hl(0, 'nimSugConverter', { fg = '#f2e9e1' }) -- Macro
hl(0, 'nimSugMacro', { fg = '#f2e9e1' }) -- Macro
hl(0, 'nimSugTemplate', { fg = '#f2e9e1' }) -- Macro
hl(0, 'nimSugField', { fg = '#f2e9e1' }) -- Identifier
hl(0, 'nimSugEnumField', { fg = '#f2e9e1' }) -- Constant
hl(0, 'nimSugForVar', { fg = '#f2e9e1' }) -- Identifier
hl(0, 'nimSugLabel', { fg = '#f2e9e1' }) -- Identifier
