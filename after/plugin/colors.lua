...
-- hl(0, 'jsGlobalObjects', { fg = '#86a943' })
-- hl(0, 'jsString', { fg = '#ffe180' })
-- hl(0, 'jsTemplateString', { fg = '#ffe180' })
-- hl(0, 'jsTemplateBraces', { fg = '#dfafff' })
-- hl(0, 'jsSpreadOperator', { fg = '#ffe180' })
-- hl(0, 'jsObjectStringKey', { fg = '#ffe180' })
-- hl(0, 'jsAsyncKeyword', { fg = '#7adffd' })
-- hl(0, 'jsForAwait', { fg = '#7adffd' })
-- hl(0, 'jsExtendsKeyword', { fg = '#ff8787' })
-- hl(0, 'jsOperatorKeyword', { fg = '#ff8787' })
-- hl(0, 'jsClassKeyword', { fg = '#ff8787' })
-- hl(0, 'jsStorageClass', { fg = '#ff5f87' })
-- hl(0, 'jsConditional', { fg = '#ff5f87' })
-- hl(0, 'jsRepeat', { fg = '#ff5f87' })
-- hl(0, 'jsString', { fg = '#ffe180' })
-- hl(0, 'jsOperator', { fg = '#ffffff' })
-- hl(0, 'jsTernaryIfOperator', { fg = '#ffffff' })
-- hl(0, 'jsReturn', { fg = '#ff5f87' })
-- hl(0, 'jsModuleAs', { fg = '#ff5f87' })
-- hl(0, 'jsExport', { fg = '#ff5f87' })
-- hl(0, 'jsExportDefault', { fg = '#ff5f87' })
-- hl(0, 'jsImport', { fg = '#ff5f87' })
-- hl(0, 'jsTry', { fg = '#ff5f87' })
-- hl(0, 'jsCatch', { fg = '#ff5f87' })
-- hl(0, 'jsFrom', { fg = '#ff5f87' })
-- hl(0, 'jsDo', { fg = '#ff5f87' })
-- hl(0, 'jsFunction', { fg = '#ff5f87' })
-- hl(0, 'jsLabel', { fg = '#ff5f87' })
-- hl(0, 'jsClassMethodType', { fg = '#ff5f87' })
-- hl(0, 'jsThis', { fg = '#7adffd' })
-- hl(0, 'jsFuncName', { fg = '#dfafff' })
-- hl(0, 'jsException', { fg = '#ff5f87' })
-- hl(0, 'jsObjectFuncName', { fg = '#dfafff' })
-- hl(0, 'jsArrowFunction', { fg = '#dfafff' })
-- hl(0, 'jsComment', { fg = '#696363' })
-- hl(0, 'jsFuncCall', { fg = '#e6b52e' })
-- hl(0, 'jsFuncArgs', { fg = '#ffbecb' })
-- hl(0, 'jsSpecial', { fg = '#e9890d' })
-- hl(0, 'jsRegexpString', { fg = '#e9890d' })
-- hl(0, 'jsRegexpOr', { fg = '#e9890d' })
-- hl(0, 'jsRegexpCharClass', { fg = '#e9890d' })
-- hl(0, 'jsRegexpQuantifier', { fg = '#e9890d' })
-- hl(0, 'jsConstant', { fg = '#ef9090' })
-- hl(0, 'jsNull', { fg = '#ef9090' })
