...
highlight jsModuleAs guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
...
highlight typescriptModule guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptImport guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptDefault guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptExport guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptInterfaceKeyword guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptInterfaceExtends guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptClassKeyword guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptClassExtends guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptVariable guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptClassName guifg=#ffbecb guibg=NONE gui=NONE ctermfg=217 ctermbg=NONE cterm=NONE
...
highlight typescriptGlobal guifg=#ff8787 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptOptionalMark guifg=#ff8787 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptMemberOptionality guifg=#ff8787 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptOperator guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptAsyncFuncKeyword guifg=#01a8c6 guibg=NONE gui=NONE ctermfg=38 ctermbg=NONE cterm=NONE
...
highlight typescriptMember guifg=#ffffff guibg=NONE gui=NONE ctermfg=231 ctermbg=NONE cterm=NONE
highlight typescriptCall guifg=#f8f8f0 guibg=NONE gui=NONE ctermfg=231 ctermbg=NONE cterm=NONE
highlight typescriptDestructureVariable guifg=#c7cadf guibg=NONE gui=NONE ctermfg=253 ctermbg=NONE cterm=NONE
highlight typescriptEndColons guifg=#c7cadf guibg=NONE gui=NONE ctermfg=253 ctermbg=NONE cterm=NONE
highlight typescriptParamImpl guifg=#f8f8f0 guibg=NONE gui=NONE ctermfg=231 ctermbg=NONE cterm=NONE
highlight typescriptIdentifier guifg=#88dddd guibg=NONE gui=NONE ctermfg=80 ctermbg=NONE cterm=NONE
...
highlight typescriptPredefinedType guifg=#ffbecb guibg=NONE gui=NONE ctermfg=217 ctermbg=NONE cterm=NONE
highlight typescriptTypeReference guifg=#ffbecb guibg=NONE gui=NONE ctermfg=217 ctermbg=NONE cterm=NONE
highlight typescriptAliasDeclaration guifg=#ffbecb guibg=NONE gui=NONE ctermfg=217 ctermbg=NONE cterm=NONE
highlight typescriptTypeParameter guifg=#ffbecb guibg=NONE gui=NONE ctermfg=217 ctermbg=NONE cterm=NONE
highlight typescriptGlobalMethod guifg=#d08770 guibg=NONE gui=NONE ctermfg=208 ctermbg=NONE cterm=NONE
highlight typescriptCase guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptForOperator guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
...
highlight typescriptCastKeyword guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptAliasKeyword guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptConditional guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptTry guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptExceptions guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptStatementKeyword guifg=#ff5f87 guibg=NONE gui=NONE ctermfg=204 ctermbg=NONE cterm=NONE
highlight typescriptString guifg=#fdf088 guibg=NONE gui=NONE ctermfg=80 ctermbg=NONE cterm=NONE
highlight typescriptTemplate guifg=#fdf088 guibg=NONE gui=NONE ctermfg=80 ctermbg=NONE cterm=NONE
highlight typescriptTemplateSubstitution guifg=#ffbb29 guibg=NONE gui=NONE ctermfg=214 ctermbg=NONE cterm=NONE
